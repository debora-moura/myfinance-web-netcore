...
{
    public class TrasacaoController : Controller
    {
        private readonly ILogger<TrasacaoController> _logger;

        public TrasacaoController(ILogger<TrasacaoController> logger)
        {
            _logger = logger;
        }
